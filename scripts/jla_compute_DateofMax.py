...
def compute_date_of_max(options):
    ...
    #lightCurveFits=JLA.get_full_path(params[options.lcfits])
    ...
    for SN in SNe:
        ...
        JLA.insertDateOfMax(SN['name'].strip(),inputFile,outputFile,options.workArea, options.force)
...
if __name__ == '__main__':
    ...
    parser.add_option("-f", "--force", dest="force", default=True, 
                      action='store_true', help="force day of max")
